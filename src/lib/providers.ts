...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'xai', name: 'xAI', icon: '✖️', placeholder: 'xai-...', model: 'Grok', requiresApiKey: true, defaultBaseUrl: 'https://api.x.ai/v1', showModelId: true, modelIdPlaceholder: 'grok-4.20-0309-non-reasoning', defaultModelId: 'grok-4.20-0309-non-reasoning', apiKeyUrl: 'https://console.x.ai/', docsUrl: 'https://docs.x.ai/' },
